  ...
  return (
    <div style={{
      ...
      <div className="window" style={{
        position:'relative', width:'min(800px, calc(100vw - 40px))',
        height:'min(88vh, calc(100vh - 60px))', display:'flex', flexDirection:'column',
        ...
        <div style={{display:'flex', flex:1, overflow:'hidden', minHeight:0}}>
          ...
          <div ref={listRef} style={{
            width:'min(280px, 35%)', flexShrink:0, overflowY:'auto',
